...
$kullanici=$sorgu->fetch(PDO::FETCH_ASSOC); # VERİLERİ ÇEKTİM
                    ...
                    <form action="islemler/ajax.php" method="POST" accept-charset="utf-8">
                        <div class="form-row">
                            <div class="col-md-6 form-group">
                                <label>İsim</label>
                                <input type="text" name="kul_isim"  class="form-control" value="<?php echo $kullanici['kul_isim']?>" placeholder="İsminizi Girin"> <!-- tek tek ekledik artık orfilde bilgilerimiz gözükücek-->
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mail</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 form-group">
                                <label>Telefon</label>
                                <input type="text" name="kul_telefon" class="form-control" value="<?php echo $kullanici['kul_telefon']?>"
